...
public class MyGreep extends Greep
{
    ...
    private static final int TOMATO_FOUND = 1;
    ...
    public void act()
    {
        ...
        if(carryingTomato()){
            ...
            setRotation (rotation + Greenfoot.getRandomNumber(1) * 180 - 90);
            move();
        }else {
            randomWalk();
        ...
        if (atWater() || moveWasBlocked()){
            int rotation = getRotation();
            setRotation (rotation + Greenfoot.getRandomNumber(2) * 180 - 90);
            move();
        }
    }
    ...
    {
        return "Group 3";  // write your name here!
    }
    
    public void dropOffTomato(){
        if (carryingTomato()) {
            if(atShip()) {
                dropTomato();
            }
